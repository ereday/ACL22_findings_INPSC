...
def run_fold_experiment(params,trn_df,val_df,tst_df,is_final=False):
    ...
    args = {
        ...
        'theta_param':params['theta_param'],
    }
...
def main_final():
    ...
    params = {                
                'output_dir':'./outputs/crr_irr_models',
               'output_model_file':'./outputs/crr_irr_models',
               'only_generate': False,
               ...
               'theta_param': float(sys.argv[7]), #alpha of irr reg.
               'max_seq_len':200,
